  ...
  return (
    ...
    >
      <button
        onClick={onDecrement}
        className={cn(
          'flex items-center justify-center flex-shrink-0 h-full transition-all ease-in-out duration-300 focus:outline-none',
          {
      ...
      <button
        ...
        disabled={disabled}
        className={cn(
          'group flex items-center justify-center h-full flex-shrink-0 transition-all ease-in-out duration-300 focus:outline-none',
          {
